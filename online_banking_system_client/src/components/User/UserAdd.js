...
const UserAdd = () => {
   ...
   // Alert message for displaying success and error ////
   const [diplay, hidePassword] = useState('block123');
   ...
   useEffect(() => {
      ...
      if(window.sessionStorage.getItem("user_level_id") == 2|| window.sessionStorage.getItem("user_level_id") == 3 || window.sessionStorage.getItem("user_level_id") == 4 ) {
         hidePassword('none');
      }
                              ...
                              <form  onSubmit={onSubmit} className="form-horizontal">
                                 <div>
                                    <div className="row">
                                       ...
                                       <div className="col" style={{display:diplay}}>
                                          ...
                                          <select id="inputState" name="user_level_id" value={formData.user_level_id} className="form-control" required onChange={e => onChange(e)} >
                                             ...
                                             <option value="2">Indian Account</option>
                                             <option value="2">NRI Account</option>
                                          </select>
                                       </div>
                                    </div>
                                 </div>
                                 <div style={{display:diplay}}>
                                    <div className="row">
                                       ...
                                       <div className="col">
                                          ...
                                          <input type="password" className="form-control" id="user_confirm_password" name="user_confirm_password" onChange={e => onChange(e)}   />
                                       </div>
                                    </div>
                                 </div>
                                 <div className="row">
