...
const KycList = () => {
   ...
   const search_data = () => {
      const newData = categories.filter(kyc => {
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-12">
                     <h2 className="pageTitle">All Banking Services</h2>
                  </div>
               </div>
            </div>
         </section>
                  ...
                  <div className="col-md-12">
                     ...
                     <form className="form-horizontal search_box">
                        <div className="form-group">
                           <label className="col-sm-2" htmlFor="email">Search Services:</label>
                     ...
                     filteredData
                        .map(kyc =>
                           ...
                           <div class="single_service">
                               <div class="thumb">
                                 <img className="home-pic-1" style={{height:"150px"}} src={"http://127.0.0.1:8080/uploads/"+kyc.kyc_image_filename} />
                               </div>
                               <div class="service_info">
                                   <h3><Link to={"/products/"+kyc.kyc_id}>{kyc.kyc_number}</Link></h3>
                               </div>
                           </div>
                       </div>
                    )
